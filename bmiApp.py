...
st.write("กรอกข้อมูลน้ำหนักส่วนสูงของคุณ เพื่อเช็กสุขภาพเบื้อต้น")

#ส่วนที่ 2 สร้างช่องน้ำหนัก และ ส่วนสูง
...
if st.button("คำนวณค่า BMI 🎯 "):
    ...
    st.write("---")
    st.header(f"ค่า BMI ของุณคือ: **{bmi:.2f}**")
    
#ส่วนที่ 4 แปลผลค่า BMI ตามเกณฑ์
    if bmi < 18.5:
        st.warninmg("⚠️ คุณมีน้ำหนักน้อยกว่าเกณฑ์ (ผอม)")
    elif 18.5 <= bmi < 23.0:
